Feature: My First Cucumber test
  ...
  Scenario: Bing search, using selenium on Mozilla
    ...
    Then the page should contain more than 100 occurrences of the text "Selenium" using Mozilla
  ...
  Scenario: Bing search, using selenium on Chrome
    ...
    Then the page should contain more than 100 occurrences of the text "Selenium" using Chrome

  Scenario: Bing search, using selenium on IE
    Given I have navigated to Bing using IE
    When I type "Selenium" in the search box using IE
    And Press <Enter> using IE
    Then the page should contain more than 100 occurrences of the text "Selenium" using IE
